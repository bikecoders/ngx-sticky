...
@Component({
  ...
  template: `
    <div id="body-container" #scCont>
      ...
      ></div>
      <div id="trigger-here" class="super-height"></div>
    </div>
  `,
})
...
describe('StickyDirective', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [DummyComponent, StickyDirective],
    }).compileComponents();
  });
  ...
  describe('Elements Setter', () => {
    ...
    describe('Setters', () => {
      ...
      it('should the setter of scrollContainer call the setHTMLElement correctly', () => {
        directive.scrollContainer = 'body-container';
        expect(setHTMLElementSpy).toHaveBeenCalledWith(
          '_scrollContainer',
          'body-container'
        );
      });
  ...
  describe('Class when sticky', () => {
    it('should put and remove the classes when sticky', (done: DoneFn) => {
      ...
      (directive as any).onAppears = new Proxy((directive as any).onAppears, {
      ...
      of({})
        .pipe(
          ...
          tap(() =>
            expect(stickyElement.classList.contains('when-sticky')).toBeTruthy(
          ...
          tap(() =>
            expect(stickyElement.classList.contains('when-sticky')).toBeFalsy(
